...
TEMP_SFTP_FILE='./site/* /findmeapp/site/www/'
...
if test $9 == "true";then
  echo 'Start delete remote files'
  ssh -p $3 -i $TEMP_SSH_PRIVATE_KEY_FILE $1@$2 rm -rf $6
fi
...
if test $7 = "true"; then
  ...
  echo 'Create directory if needed'
  ssh -p $3 -i $TEMP_SSH_PRIVATE_KEY_FILE $1@$2 mkdir -p $6
fi
